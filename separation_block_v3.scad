...
// with the trimline and the flag line. It is used in a trim line 
// system with a 2-to-1 mechanical advantage. The separation block
// functions as the pulley for the trim line. This model requires no 
...
// Uncomment these lines to see a comparison with separation_block_v1
//translate([0,20,0])
...
// enough to accommodate a 4mm line spliced into a loop. Larger, more 
// comfortable trim lines would require a larger bore diameter.
// 
trim_line_diameter = 8;
trim_line_bore_minor_radius = trim_line_diameter / 2;
trim_line_bore_major_radius = overall_width / 2;
trim_line_bore_translation = -3;
